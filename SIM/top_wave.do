...
add wave -noupdate /tb_top/ITCM_tb_in
add wave -noupdate /tb_top/ITCM_tb_addr_in
add wave -noupdate /tb_top/DTCM_tb_wr
add wave -noupdate /tb_top/DTCM_tb_in
add wave -noupdate /tb_top/DTCM_tb_addr_in
add wave -noupdate /tb_top/DTCM_tb_addr_out
add wave -noupdate /tb_top/DTCM_tb_out
...
update
WaveRestoreZoom {0 ps} {1084550 ps}
